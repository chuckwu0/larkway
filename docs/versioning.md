...
| v0.3.53 | v0.3.53 | 当前 patch / 已发布 | peer-handoff fast path: state.json handoffs → bridge-sent mirror post + same-process local dispatch (WS copy deduped); LARKWAY_LOCAL_HANDOFF=off kill switch |
